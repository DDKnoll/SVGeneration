...
SVGeneration.Editor = React.createClass({displayName: "Editor",
  ...
  renderSVG: function(){
    ...
    div.setAttribute('class', 'svg-target');
    var style = "backgroundColor: #"+(this.state.image.bgColor ? this.state.currentParameters[this.state.image.bgColor] : 'ffffff')+';';
    style = style + this.state.image.cssRules;
    style = " background-image:"+this.dataURI()+";"
